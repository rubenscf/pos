Public NotInheritable Class PantallaPresentacion
    ...
    Private Sub PantallaPresentacion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
