...
Public Class ctrlGestionContratos
    ...
    Private Sub dg_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dg.CellClick
        Try
            Me.DE_CREDITOSTableAdapter.Fill(Me._DS.DE_CREDITOS, New System.Nullable(Of Decimal)(CType(dg.CurrentRow.Cells(0).Value, Decimal)), New System.Nullable(Of Decimal)(CType(dg.CurrentRow.Cells(1).Value, Decimal)))
        Catch ex As System.Exception
            System.Windows.Forms.MessageBox.Show(ex.Message)
        End Try
